...
ZeroDev is a **smart embedded wallet** for building user-friendly Web3 experiences, particularly for DeFi applications.  By "smart," we refer to the fact that we use account abstraction (AA).

ZeroDev is one of the most trusted solutions in AA, having deployed more than 50% of all AA wallets and is currently powering a majority of DeFi volume that leverages AA.
