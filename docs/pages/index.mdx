...
ZeroDev can be used as a standalone embedded smart account, or used alongside auth providers such as [Privy](/sdk/signers/privy) and [Dynamic](/sdk/signers/dynamic).
