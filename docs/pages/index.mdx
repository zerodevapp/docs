...
- [**Modular smart accounts**](/sdk/permissions/intro) -- you can configure the smart account with plugins to enable features like passkeys, session keys, account recovery, etc.
