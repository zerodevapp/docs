...
- If you are building a DApp, get started with [the capabilities API](/smart-wallet/quickstart-capabilities).
- If you are building a wallet, get started with the [Core SDK](/smart-wallet/quickstart-core) or the [React SDK](/smart-wallet/quickstart-react).
- If you are unsure, [read this first](/smart-wallet/which-sdk).