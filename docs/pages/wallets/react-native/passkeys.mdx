...
The `useRegisterPasskey` and `useLoginPasskey` hooks work identically to [the web](/wallets/auth/passkeys) on React Native, but they require a native passkey stamper and some platform setup.
