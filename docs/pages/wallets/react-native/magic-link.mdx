...
The `useSendMagicLink` and `useVerifyMagicLink` hooks work identically to [the web](/wallets/auth/magic-link) on React Native, but the redirect needs platform setup.
...
### Add the send panel with `useSendMagicLink`
