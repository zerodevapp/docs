...
```bash [npm]
npm i @zerodev/wallet-react@0.0.1 @zerodev/wallet-core@0.0.1 wagmi viem @wagmi/core @tanstack/react-query
```

```bash [yarn]
yarn add @zerodev/wallet-react@0.0.1 @zerodev/wallet-core@0.0.1 wagmi viem @wagmi/core @tanstack/react-query
```

```bash [pnpm]
pnpm add @zerodev/wallet-react@0.0.1 @zerodev/wallet-core@0.0.1 wagmi viem @wagmi/core @tanstack/react-query
```

```bash [bun]
bun add @zerodev/wallet-react@0.0.1 @zerodev/wallet-core@0.0.1 wagmi viem @wagmi/core @tanstack/react-query
```
