...
Want less code to get started even faster? Try the optional [Wallet UI Kit](/wallets/auth/wallet-ui-kit) for a prebuilt login flow.
...
The examples above use `@zerodev/wallet-react` so you can build your own UI. If you want a prebuilt login flow, use the optional [Wallet UI Kit](/wallets/auth/wallet-ui-kit). Keep the white-label hooks path if you want full control over layout, styling, and bundle size.
...
- [Email OTP](/wallets/auth/email-otp)
- [Google OAuth](/wallets/auth/google-oauth)
- [Send Transactions](/wallets/wallet-api/send-transaction)
