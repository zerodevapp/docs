...
This hook can be called without mutation variables. It triggers the browser's WebAuthn prompt to create a new passkey.

### connector

`Connector | undefined`

Optional Wagmi connector to register the passkey with. If omitted, the hook uses the configured ZeroDev connector.
