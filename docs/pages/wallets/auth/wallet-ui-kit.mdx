...
`AuthFlow` renders into the width you give it. Put it in a constrained container, modal, or drawer instead of letting it stretch across the full page on large screens.
