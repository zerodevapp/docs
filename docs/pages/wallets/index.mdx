...
Adding ZeroDev Wallet takes three steps — or drop in the prebuilt [Wallet UI Kit](/wallets/auth/wallet-ui-kit) for a ready-made login flow and the fastest possible startup. See it in the [live demo](https://zerodev-signer-demo.vercel.app/), or follow the [quickstart](/wallets/quickstart) to build it yourself.
...
- Drop in the prebuilt [Wallet UI Kit](/wallets/auth/wallet-ui-kit) for a login flow with even less code.
...
Interested in exploring these, or have another feature request? [Reach out](https://t.me/derek_chiang).
...
- **Rate limits:** default per-user rate limits protect against spam draining your credits. They're flexible — [contact us](https://t.me/derek_chiang) to adjust them for your app.
