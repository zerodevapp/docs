...
Once you've implemented a signer of the `SmartAccountSigner` type, you should be able to [use it with a validator](/sdk/core-api/create-account#creating-a-ecdsa-validator).