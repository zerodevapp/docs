...
If you would like to use ZeroDev directly with a Dynamics project, you can set up a custom integration using Dynamic's EOA as a signer.
...
Use the WalletClient from Dynamic to create a smart account signer, which can be passed to a validator. For detailed guidance on using a validator, refer to our documentation on [creating accounts](/sdk/core-api/create-account#api).
