...
- For more information on how to get started, visit the Privy's [Account Abstraction documentation](https://docs.privy.io/wallets/using-wallets/evm-smart-wallets/overview).
...
Use the Privy provider to create a smart account signer that can be passed to a validator. For detailed guidance on using a validator, refer to our documentation on [creating accounts](/sdk/core-api/create-account#api).
