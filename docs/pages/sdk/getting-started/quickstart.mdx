...
:::info
Impatient?  Check out [the complete example here](https://github.com/zerodevapp/zerodev-examples/tree/main/quickstart/completed.ts).
:::
...
Now open the [`quickstart/template.ts`](https://github.com/zerodevapp/zerodev-examples/blob/main/quickstart/template.ts) file in your editor.  This will be the template where you will write your code.  You can always refer to [`quickstart/completed.ts`](https://github.com/zerodevapp/zerodev-examples/blob/main/quickstart/completed.ts) to see the completed tutorial code.
