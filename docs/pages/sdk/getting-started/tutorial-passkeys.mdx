...
In this tutorial, we will be building a Next.js app where your users can create smart accounts and send UserOps with [passkeys](http://localhost:5173/sdk/plugins/passkeys).
...
If you ever want to check out the completed code, you can checkout the `completed` branch.
