...
In this example, we will use [the Odyssey testnet](https://hub.conduit.xyz/odyssey), but you can use any 7702-compatible network such as Holesky.
...
If you are using the Holesky testnet, also set an RPC for holeskey, e.g.:
