...
In this example, we will upgrade a EOA into a ZeroDev smart account ([Kernel](https://github.com/zerodevapp/kernel)) and send a sponsored batched transaction from it.
...
In this example, we will use [the Odyssey testnet](https://hub.conduit.xyz/odyssey), but you can use any 7702-compatible networks
...
Use the bundler/paymaster RPCs from your project home.  For the private key, use any testing EOA key.
...
Now you can use the ZeroDev SDK as usual.  For example, to sent a batched UserOp:
...
Easy, right?  Now explore the rest of the ZeroDev docs and see what you can do now that your EOA is a smart account.