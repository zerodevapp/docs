# Installing permission during account creation

You can install permission plugins during account creation using `initConfig`. This approach lets you set up permissions when the account is deployed.
