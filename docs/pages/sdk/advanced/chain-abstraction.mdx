...
This guide is for using CAB directly through the ZeroDev SDK, which allows for fine-grained control.  To learn more about how CAB works, [read this](/magic-account/why-chain-abstraction).
