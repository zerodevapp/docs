...
In the "cross-chain transactions" example, you were explicitly specifying the chains for your input tokens.  If you don't care which chains to spend from, you can simply skip `inputTokens`, and the SDK will automatically figure out which chains to spend from.  This essentially enables you to spend from your chain-abstracted balance (CAB):
...
By default, the SDK pulls input tokens from chains with the highest balance, if you would like to use a different logic, get in touch.
