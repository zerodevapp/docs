...
ZeroDev aggregates multiple bundler and paymaster services to provide the highest possible reliability to our users. You can set up “fallbacks” so that when one service fails, another takes over.
