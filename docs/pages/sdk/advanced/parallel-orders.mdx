...
With a EOA, the nonce is sequential: 1, 2, 3,... meaning transaction ordering occurs sequentially, and a transaction cannot be processed unless the previous transaction has completed.
