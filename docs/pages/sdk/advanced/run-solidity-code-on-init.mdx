...
Sometimes, you may want to execute some custom code when you create an account. One common use case is emitting an event whenever a user creates an account.
...
- Install the validator on your account during initialization.

## Developing a custom validator

The kernel implements the [ERC-7579 interface](https://eips.ethereum.org/EIPS/eip-7579) so that you can write a 7579 validator.
