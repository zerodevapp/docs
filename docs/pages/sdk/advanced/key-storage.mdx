...
The remote signer feature is a paid add-on. Please [get in touch](https://t.me/derek_chiang) with us before using this feature in production to avoid service disruptions.

:::

Sometimes you can manage session keys or even actual private keys for your users, but you may not want to store them in your database.
...
`remoteSigner` is a [Viem account](https://viem.sh/docs/accounts/privateKey) you can use to sign.
