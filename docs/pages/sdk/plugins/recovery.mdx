...
The recovery plugin is currently being ported to ZeroDev from the old ZeroDev SDK.  You can find [recovery docs for the old SDK here](https://docs-v4.zerodev.app/use-wallets/recovery).