...
:::info
Impatient?  Check out [complete examples here](https://github.com/zerodevapp/kernel.js-examples/blob/main/delegatecall/main.ts).
:::
...
To send a UserOp that uses `delegatecall`, simply specifies the `callType` of the UserOp:
