...
Note that if you had constructed your `kernelClient` with a [preset](/sdk/presets/intro), you may not have access to a bundler client.  Instead, you can extend your `kernelClient` with bundler actions:
