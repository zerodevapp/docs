...
To install the ZeroDev SDK and its peer dependencies:

:::code-group

```bash [npm]
npm i @zerodev/sdk viem permissionless
```

```bash [yarn]
yarn add @zerodev/sdk viem permissionless
```

```bash [pnpm]
pnpm i @zerodev/sdk viem permissionless
```

```bash [bun]
bun i @zerodev/sdk viem permissionless
```
