...
Kernel versions 2.x are compatible with EntryPoint 0.6 and Kernel versions 3.x+ are compatible with EntryPoint 0.7.
...
const kernelVersion = KERNEL_V3_1 // or KERNEL_V2_4 
```
