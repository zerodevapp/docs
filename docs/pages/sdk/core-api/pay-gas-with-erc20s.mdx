...
ZeroDev supports USDC paymasters through two APIs: the Circle API and the Legacy API.  Generally, the Circle API gives you better exchange rates, while the Legacy API is available on more networks.
