...
Below is an example demonstrating how to use a KernelClient with the EIP1193Provider. This example assumes you are familiar with the creating of a KernelClient. For detailed instructions on creating a KernelClient, please refer to our [tutorial page](/sdk/getting-started/tutorial#creating-a-kernel-client).
