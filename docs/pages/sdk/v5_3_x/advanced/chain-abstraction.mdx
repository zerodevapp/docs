...
This guide is for using CAB directly through the ZeroDev SDK, which allows for fine-grained control.  To learn more about how CAB works, [read this](/sdk/v5_3_x/faqs/why-chain-abstraction).
