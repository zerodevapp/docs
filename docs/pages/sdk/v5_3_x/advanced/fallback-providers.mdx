...
When you use ZeroDev, you can pick [a specific infrastructure provider](/resources/infrastructure/rpcs#bundler-rpc).  If you don't pick one, we pick one for you.
