...
In Viem, a [public client](https://viem.sh/docs/clients/public.html) is an interface to a JSON-RPC API such as Infura or Alchemy.  For testing, you can use the bundler RPC here, but for production, you must use your own RPC (e.g. Infura/Alchemy) or you might get rate-limited.
...
const publicClient = createPublicClient({
  ...
  // Use the bundler RPC only for testing.
