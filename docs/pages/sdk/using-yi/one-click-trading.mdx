...
Yi supports "permissions" through [ERC-7715](/sdk/knowledge-base/permissions), a standard coauthored by ZeroDev, WalletConnect, MetaMask, Coinbase, and Biconomy.  A Yi user can grant permissions to the DApp to execute specific transactions on their behalf.  For example, the user might say:
