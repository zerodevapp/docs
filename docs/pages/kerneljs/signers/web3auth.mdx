...
To use Web3Auth with kernel.js, first create an application that integrates with Web3Auth.
...
## Integration
Integrating kernel.js with Web3Auth is straightforward after setting up the project. Web3Auth provides an Externally Owned Account (EOA) wallet to use as a signer with Kernel.
...
const smartAccountSigner = providerToSmartAccountSigner(web3authProvider);
