...
**Kernel.js** is an SDK for developing [account abstraction](https://www.erc4337.io) wallets and DApps using [Kernel](/kernel/intro), a smart contract account (or "smart account" for short) that is:
...
- [Core API](/kerneljs/core-api): the main things you want to do with a smart account, such as sponsoring gas, batching UserOps, etc.
