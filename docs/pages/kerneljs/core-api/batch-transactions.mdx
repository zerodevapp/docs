...
:::info
Impatient?  Check out [complete examples here](https://github.com/zerodevapp/kernel.js-examples/tree/main/batch-transactions).
:::
...
You can learn more about the `sendUserOperation` API [here](/kerneljs/core-api/send-transactions#sending-raw-userops).
