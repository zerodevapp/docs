...
ZeroDev supports social logins natively, but you can also use ZeroDev with [third-party auth providers](/onboarding/auth-providers) such as Privy, Dynamic, and Magic if you prefer their UI.
