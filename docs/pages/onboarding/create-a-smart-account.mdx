...
:::details[When I create an account, is it deployed on-chain?]
...
:::details[Can I create multiple accounts from the same EOA signer?]
...
:::details[How do I get the smart account address from the EOA signer address?]
...
:::details[How do I get the EOA signer address from the smart account address?]
...
:::details[How do I create a Kernel account object with a specific address?]
