# Use an EOA with ZeroDev [An Externally Owned Account (EOA) is a standard Ethereum account operated via a private key.]

It's commonly used in wallets like MetaMask. ZeroDev is compatible with EOAs as signers, and the method of integrating an EOA varies based on your dApp's connection approach.
