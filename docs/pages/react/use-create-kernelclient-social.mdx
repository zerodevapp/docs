...
The callback URL for social login. After a successful login, the user will get redirected to this URL. Defaults to the current URI of your application if not specified.
