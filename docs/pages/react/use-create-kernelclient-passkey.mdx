...
The mutation function registers the passkey and creates the kernel smart account.
...
The mutation function for login creates a passkey and creates the kernel smart account.
