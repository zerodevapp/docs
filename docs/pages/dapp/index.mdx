...
Read on to learn about [How Yi Works](#how-yi-works) and [What makes Yi different than other AA solutions](#what-makes-yi-different-than-other-aa-solutions).
...
## What makes Yi different than other AA solutions?
...
Incidentally, Yi is also the first AA solution to support true chain-abstraction, giving it more power than all AA solutions to date.