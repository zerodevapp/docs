...
Now you can send a sponsored transaction with the capability API, which is already supported in Viem and Wagmi.

Send a sponsored transaction through Wagmi:
