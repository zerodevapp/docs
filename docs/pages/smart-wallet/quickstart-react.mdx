...
Just like all Wagmi projects, you want to [set up the Wagmi config.](https://wagmi.sh/react/getting-started)

## 4. Setup context provider

Now, create a `ZeroDevProvider` and nest it within the Wagmi provider.
