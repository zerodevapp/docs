...
```typescript
import { toWebAuthnSigner, toWebAuthnKey, WebAuthnMode, WebAuthnSignerVersion} from "@zerodev/permissions/signers"

const passkeyName = "Key Name"  // any name you want
const passkeyServerUrl = "..."  // get this from ZeroDev dashboard
const mode = WebAuthnMode.Register  // can also be WebAuthnMode.Login if you are using an existing key
