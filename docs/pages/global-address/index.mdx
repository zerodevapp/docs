...
- Using a fiat onramp with an L2/L3, even if the onramp doesn't directly support the L2/L3.
...
The Smart Routing Address has a beautifully simple API: create a Smart Routing Address and then send funds to it. That’s really it.
