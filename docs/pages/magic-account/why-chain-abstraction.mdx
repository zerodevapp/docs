...
Magic Account enables chain abstraction by implementing a protocol known as "MagicSpend++".  You can [read more about the protocol here](/magic-account/knowledge-base/chain-abstraction), but here's a quick summary of how MagicSpend++ (as implemented in Magic Account) works:
