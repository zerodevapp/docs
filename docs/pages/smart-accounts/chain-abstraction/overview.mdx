...
# Chain abstraction [ZeroDev is the first smart account solution to support cross-chain transactions, also sometimes known as "chain abstraction."]
...
- Execute a transaction on Bsc by paying gas in DAI from Optimism.

## Features

<Cards>
  <Card icon="key" title="Compatible with EIP-7702">
  ...
  <Card icon="chain" title="Cross-chain without bridging">
  ...
  <Card icon="send" title="Unparalleled speed">
  ...
  <Card icon="vault" title="Deep liquidity">
...
First, make sure you know how to [create ZeroDev accounts](/onboarding/create-a-smart-account).
