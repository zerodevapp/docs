...
To avoid over-spending gas on sponsoring, you must set up gas-sponsoring policies.  Sign up on the ZeroDev dashboard if you haven't already, then [set up gas policies](/resources/infrastructure/gas-policies).
...
If you have reached the sponsorship limit, either because of the [policies](/resources/infrastructure/gas-policies) you set up or because you have reached an account-level limit, sending UserOp will fail.
