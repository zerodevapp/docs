# Sponsor Gas on Solana [With ZeroDev, you can sponsor transaction fees for your users on Solana, so they don't need to hold SOL to interact with your DApp.]
...
### Create the sponsorship and Solana RPC clients
...
### Create your transaction instruction(s)
...
### Get the sponsor fee payer and build the transaction
