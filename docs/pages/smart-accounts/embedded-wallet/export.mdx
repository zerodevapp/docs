...
- [`useExportWallet`](/smart-accounts/embedded-wallet/hooks/use-export-wallet) — Export the wallet seed phrase
- [`useExportPrivateKey`](/smart-accounts/embedded-wallet/hooks/use-export-private-key) — Export a single private key
