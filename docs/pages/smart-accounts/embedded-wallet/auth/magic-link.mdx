...
- [`useSendMagicLink`](/smart-accounts/embedded-wallet/hooks/use-send-magic-link) — Send a magic link to an email address
- [`useVerifyMagicLink`](/smart-accounts/embedded-wallet/hooks/use-verify-magic-link) — Verify the magic link and authenticate
