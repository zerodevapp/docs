...
- [`useSendOTP`](/smart-accounts/embedded-wallet/hooks/use-send-otp) — Send a one-time code to an email address
- [`useVerifyOTP`](/smart-accounts/embedded-wallet/hooks/use-verify-otp) — Verify the code and authenticate
