...
- [`useRegisterPasskey`](/smart-accounts/embedded-wallet/hooks/use-register-passkey) — Create a new wallet with a passkey
- [`useLoginPasskey`](/smart-accounts/embedded-wallet/hooks/use-login-passkey) — Sign in to an existing wallet
