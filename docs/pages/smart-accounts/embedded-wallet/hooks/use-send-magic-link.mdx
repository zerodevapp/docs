...
**Required.** The URL the user will be redirected to after clicking the magic link. This should be a page in your app that calls [`useVerifyMagicLink`](/smart-accounts/embedded-wallet/hooks/use-verify-magic-link).
...
The identifier for this magic link verification. Store this value and pass it to [`useVerifyMagicLink`](/smart-accounts/embedded-wallet/hooks/use-verify-magic-link) on the redirect page.
