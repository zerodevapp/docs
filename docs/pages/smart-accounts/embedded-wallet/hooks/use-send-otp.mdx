...
The identifier for this OTP verification attempt. Pass this to [`useVerifyOTP`](/smart-accounts/embedded-wallet/hooks/use-verify-otp) to complete authentication.
