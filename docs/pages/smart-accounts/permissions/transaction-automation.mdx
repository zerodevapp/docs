# Tutorial -- Transaction Automation [In this tutorial, you will learn how to automate transactions for your users using session keys.]

Using [session keys](/smart-accounts/permissions/intro) is useful when you want to send transactions for your users from your server, for instance.
...
[Refer to this page.](/smart-accounts/multi-chain-signing)
