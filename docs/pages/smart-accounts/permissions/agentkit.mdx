...
```bash [yarn]
yarn add @coinbase/agentkit @coinbase/agentkit-langchain viem @langchain/core @langchain/openai @langchain/langgraph dotenv
```

```bash [pnpm]
pnpm add @coinbase/agentkit @coinbase/agentkit-langchain viem @langchain/core @langchain/openai @langchain/langgraph dotenv
```

```bash [bun]
bun add @coinbase/agentkit @coinbase/agentkit-langchain viem @langchain/core @langchain/openai @langchain/langgraph dotenv
```
...
```bash [bun]
bun add -d ts-node typescript @types/node
```
