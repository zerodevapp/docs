...
In practice, however, most bundler implementations except for Pimlico are not production-ready, so most ERC-4337 traffic is going through Pimlico today.  This is not unlike how [most Ethereum traffic is going through Geth](https://clientdiversity.org/).  Hopefully, this will change as other bundlers go into production.
