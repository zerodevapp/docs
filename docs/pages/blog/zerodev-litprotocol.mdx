...
date: 2025-10-28
layout: minimal
**preview: The team recently partnered with ZeroDev to bring secure, automated, and AI-powered transaction capabilities to every smart wallet via Lit Protocol's programmable key layer.**
---

# Combining Smart Accounts with Secure Automation
