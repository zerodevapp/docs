...
*Update: Noam from Alchemy has published [a response here](https://mirror.xyz/probablynoam.eth/ZM8k-YoVbC-ih13zPMPZ5q4iZ7wEHuWEcRbQNrRiURU).*

*Update 2: we published [a follow-up blog post here](https://docs.zerodev.app/blog/who-when-what).*
