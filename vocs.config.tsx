...
// lives in redirects.config.js (single source of truth); in production it is
// consolidated and applied to Render via the API by scripts/sync-render-routes.mjs.
